        ...
        <div className="card" style={{ padding: '24px' }}>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                <label className="form-label" style={{ fontWeight: '600', color: '#334155' }}>Purchase Cost (USD) <span style={{ color: 'var(--error)' }}>*</span></label>
                <div style={{ position: 'relative' }}>
                  <input
                    type="number"
                    min="0"
                    ...
                    required
                  />
                  <DollarSign size={15} style={{ position: 'absolute', left: '12px', top: '13.5px', color: '#94a3b8' }} />
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end', marginTop: '12px' }}>
              <button type="button" className="btn btn-secondary" onClick={onCancel} style={{ borderRadius: '8px' }}>
                Cancel
              </button>
              <button type="submit" className="btn btn-primary" style={{ background: 'linear-gradient(135deg, var(--primary) 0%, var(--primary-hover) 100%)', border: 'none', borderRadius: '8px' }}>
                Save Asset
              </button>
            </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px 20px', borderTop: '1px solid #f1f5f9', paddingTop: '16px', marginBottom: '20px', fontSize: '13px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontWeight: '700', color: '#0f172a', marginTop: '2px' }}>
                    {purchaseCost ? `$${parseFloat(purchaseCost).toLocaleString(undefined, { minimumFractionDigits: 2 })}` : '$0.00'}
                  </div>
                </div>
              </div>
